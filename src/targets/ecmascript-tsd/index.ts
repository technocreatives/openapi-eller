...
export default class EcmaScriptTypeScriptDefinitionTarget extends Target {
  types: TargetTypeMap = typeResolvers("ecmascript-tsd")
  ...
  generate(args: GenerateArguments): { [filename: string]: string } {
    return { "Generated.d.ts": apiTmpl(args) }
  }
}
